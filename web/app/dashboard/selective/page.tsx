...
export default function SelectiveComparisonPage() {
  ...
  return (
    <div className="p-6 md:p-10 max-w-4xl mx-auto">
      ...
      <p className="text-slate-500 font-bold mb-10">Comparez directement deux ou trois banques de votre choix.</p>
      <div className="bg-white rounded-3xl border border-dashed border-slate-200 p-16 text-center shadow-sm">
        ...
        <h3 className="font-black text-slate-700 text-xl mb-2">Bientôt disponible</h3>
